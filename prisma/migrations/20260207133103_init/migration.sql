...
-- CreateEnum
CREATE TYPE "AgeRange" AS ENUM ('AGE_3_5', 'AGE_5_8', 'AGE_8_12', 'ALL');

-- CreateEnum
CREATE TYPE "HairType" AS ENUM ('STRAIGHT', 'CURLY', 'ALL');
...
CREATE TABLE "products" (
    ...
    "categoryId" TEXT,
    "ageRange" "AgeRange" NOT NULL DEFAULT 'ALL',
    "hairType" "HairType" NOT NULL DEFAULT 'ALL',
    "colors" TEXT[],
    "images" TEXT[],
